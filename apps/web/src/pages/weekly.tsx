    ...
    <div className='Weekly focus-glow container' tabIndex={0}>
        <div className='top-selector strip'>
            ...
            <div className='Crud-btns'>
              <button className='top-btns'> {/* This button is not an arrow btn this is minus btn*/}
                <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className = 'i-rings' d="M32.5 60C47.6878 60 60 47.6878 60 32.5C60 17.3122 47.6878 5 32.5 5C17.3122 5 5 17.3122 5 32.5C5 47.6878 17.3122 60 32.5 60Z" stroke="#1E1E1E" stroke-width="4"/>
                  <path className= 'i-minus' d="M22 33H44" stroke="#1E1E1E" stroke-width="2.7" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
              ...
              <button className='top-btns'> {/* This button is not an arrow btn this is the change btn*/}
                <svg width="25" height="25" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className='i-changeBtn' d="M2.00049 32L22.0005 42L42.0005 32M2.00049 22L22.0005 32L42.0005 22M22.0005 2L2.00049 12L22.0005 22L42.0005 12L22.0005 2Z" stroke="#1E1E1E" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>

              <button className='top-btns'> {/* This button is not an arrow btn this is the save btn*/}
                <svg width="25" height="25" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path className='i-saveBtn' d="M30 38V22H10V38M10 2V12H26M34 38H6C4.93913 38 3.92172 37.5786 3.17157 36.8284C2.42143 36.0783 2 35.0609 2 34V6C2 4.93913 2.42143 3.92172 3.17157 3.17157C3.92172 2.42143 4.93913 2 6 2H28L38 12V34C38 35.0609 37.5786 36.0783 36.8284 36.8284C36.0783 37.5786 35.0609 38 34 38Z" stroke="#1E1E1E" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>

              <button className='top-btns'> {/* This button is not an arrow btn this is the add btn*/}
                <svg width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle className = 'i-rings' cx="32.5" cy="32.5" r="27.5" stroke="#1E1E1E" stroke-width="4"/>
                  <path className='i-add'd="M22 33L33 33M33 33C33 33 33 33 44 33M33 33C33 33 33 33 33 22M33 33V44" stroke="#1E1E1E" stroke-width="2.7" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
            </div>
